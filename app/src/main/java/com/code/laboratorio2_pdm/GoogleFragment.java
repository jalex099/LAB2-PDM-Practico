...
public class GoogleFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btnAtrasGoogle = (Button)view.findViewById(R.id.btnAtrasFacebook);
        Button btnGoogleToInicio = (Button)view.findViewById(R.id.btnFacebookToInicio);

        final NavController navController = Navigation.findNavController(view);

        btnAtrasGoogle.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnGoogleToInicio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
